...
<title>Daftar Artikel Penulis - Katakey</title>
    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="header-text">
          <h2>List Artikel Yang Sudah Ditulis</h2>
  ...
  <div class="wrapper">
    ...
    <div class="card">
      <div class="card-header" style="background: linear-gradient(45deg, #0f4c75, #3282b8); color: #fff; text-align: center; border-radius: 10px 10px 0 0; padding: 15px;">
          <h5 style="margin-bottom: 0; font-size: 1.5em; color: #fff;">List Artikel</h5>
      </div>
      ...
      <div class="btn-container-bottom text-center">
          <a href="/profileP" class="btn btn-warning">Kembali</a>
      </div>
      <br>
  </div>
</div>
