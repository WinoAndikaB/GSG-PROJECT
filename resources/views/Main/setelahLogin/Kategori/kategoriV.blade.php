...
<html lang="en">
  ...
  <head>
    ...
    @if($kategoriLogV->isNotEmpty())
    <title>{{ $kategoriLogV->first()->kategori }} - Katakey</title>
    @else
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="header-text">
                    @if($kategoriLogV->isNotEmpty())
                        <h2>Kategori {{ $kategoriLogV->first()->kategoriVideo }}</h2>
              ...
              @foreach ($kategoriLogV as $item)
                  <div class="row" style="text-align: justify">
                      <div class="col-lg-3 col-md-4 col-sm-12" data-aos="fade-right" data-aos-delay="200">
                        <iframe width="300" height="200" src="{{$item->linkVideo}}" frameborder="0" allowfullscreen></iframe>
                      </div>
