...
<html lang="en">
  ...
  <head>
    ...
    <title>Tags Video -  Katakey</title>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="search-container">
              <form action="{{ route('searchTagsVideoLP') }}" method="GET" class="input-group">
          ...
          <h5>Video dengan Tag: <b>{{ request()->input('search') }}</b>, {{ $videos->count() }} hasil ditemukan</h5>
          <?php
