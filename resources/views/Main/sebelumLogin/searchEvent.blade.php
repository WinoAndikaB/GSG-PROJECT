...
<html lang="en">
  ...
  <head>
    ...
    <title>Pencarian Evemt - GSG Project</title>
    ...
    <style>
      ...
      <style>
        .custom-image {
          max-width: 100%; /* Maksimum lebar adalah lebar wadah */
          height: auto; /* Biarkan tinggi mengikuti perubahan lebar */
          border-radius: 14px; /* Menerapkan border-radius */
        }
      </style>
      ...
      <div class="container">
        <div class="row">
          ...
          <div>
            ...
            <div class="search-container">
              <form action="{{ route('searchEvent') }}" method="GET" class="input-group">
                <input type="text" name="searchEvent" class="form-control" placeholder="Cari..." value="{{ request('searchEvent') }}">
          ...
          <br>
            ...
            <h5>Hasil pencarian <b>"{{ request('searchEvent') }}"</b>, {{ $eventSeach->count() }} hasil ditemukan</h5>

            <br>
            <br>

            @foreach ($eventSeach as $item)
