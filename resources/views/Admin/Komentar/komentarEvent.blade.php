        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <a href="/eventKomAd" class="btn btn-primary">Event</i></a>
                            ...
                            <tbody>
                              <tr>
                                ...
                                <td class="align-middle">
                                  <a href="#" class="btn btn-danger btn-icon btn-round" onclick="showConfirmationModal('{{ route('deleteKomentarEvent', ['id' => $item['id']]) }}')">
