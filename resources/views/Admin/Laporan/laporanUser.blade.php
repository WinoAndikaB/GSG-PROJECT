        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <a href="/laporanUser" class="btn btn-primary">Laporan Artikel + {{ $dataBaruLaporanArtikel}}</a>
              <a href="/laporanVideoUser" class="btn btn-primary">Laporan Video + {{ $dataBaruLaporanVideo}}</a>
              <h6>Laporan Artikel</h6>
            </div>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="align-middle">
                                      ...
                                      <a href="{{ route('showDetailArtikelA', ['id' => $item->artikel->id]) }}" class="btn btn-info btn btn-primary btn-round">
                                        <i class="fas fa-info-circle"></i>
                                    </a>

                                      <a href="#" class="btn btn-danger btn-icon btn-round" onclick="showConfirmationModal('{{ route('deleteLaporanUA', ['id' => $item['id']]) }}')">
          ...
          $('.dropdown-item').click(function(e) {
              ...
              $.ajax({
                  ...
                  success: function(response) {
                      ...
                      window.location.href = '{{ route("laporanUser") }}';
                  },
