                      ...
                      <div class="card-body px-0 pt-0 pb-2">
                        <div class="table-responsive p-0">
                          ...
                          <div class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink2">
                                <li>
                                    <a class="dropdown-item" href="{{ route('laporanUserSA') }}">
                                        All ({{ $AllTotalLaporan }})
                                    </a>
                                </li>
                                @foreach($FilterLA as $filter)
                                <li>
                                    <a class="dropdown-item" href="{{ route('laporanUserSA', ['laporan' => $filter['laporan']]) }}">
        ...
        $('.dropdown-item.artikel').click(function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    window.location.href = '{{ route("laporanUserSA") }}';
                },
