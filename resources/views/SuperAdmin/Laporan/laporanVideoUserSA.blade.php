                    ...
                    <div class="card mb-4">
                      ...
                      <div class="card-body px-0 pt-0 pb-2">
                        ...
                        <div class="dropdown">
                          ...
                          <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink2">
                              <li>
                                  <a class="dropdown-item" href="{{ route('laporanVideoUserSA') }}">
                                      All ({{ $AllTotalLaporan }})
                                  </a>
                              </li>
                              @foreach($FilterLV as $filter)
                              <li>
                                  <a class="dropdown-item" href="{{ route('laporanVideoUserSA', ['laporan' => $filter['laporan']]) }}">
                                  ...
                                  <tr>
                                    ...
                                    <td class="align-middle">
                                      <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink2">
                                            <li>
                                                <a class="dropdown-item video" href="#" data-laporan-id="{{ $item->id }}">
                                                    Tindakan Selesai
                                                </a>
                                            </li>
                                            <li>
...
<script>
    $(document).ready(function() {
        $('.dropdown-item.video').click(function(e) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    window.location.href = '{{ route("laporanVideoUserSA") }}';
                },
