        ...
        <li class="nav-item">
          <a class="nav-link active" href="/eventKomAdSA">
            ...
            <span class="nav-link-text ms-1">Event 
              <span class="text-success text-sm font-weight-bolder text-white">+ {{ $dataBaruEventKomunitas}}</span> 
            </span>
          </a>
        </li>
        <li class="nav-item">
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <h6>Tambah Event</h6>
              <form action="{{ route('storeEventSA') }}" method="POST" enctype="multipart/form-data">
                @csrf
