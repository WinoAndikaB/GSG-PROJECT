...
<head>
  ...
  <title>
    Form Tambah Kategori | GSG PROJECT
  </title>
  <!--     Fonts and icons     -->
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder text-white mb-0">Form Tambah Kategori </h6>
        </nav>
            ...
            <div class="card-header pb-0">
              ...
              <form action="{{ route('storeKategorioSA') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" type="text" name="deskripsiKategori" id="editor"></textarea>
                </div>
