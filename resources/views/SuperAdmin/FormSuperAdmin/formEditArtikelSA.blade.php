          ...
          <div class="card mb-4">
            <div class="card-header pb-0">
              ...
              <form action="/formEditArtikelSA/updateArtikelSA/{{$data->id}}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <br>
                    @if($data->gambarArtikel)
                        @if(filter_var($data->gambarArtikel, FILTER_VALIDATE_URL))
                            <a href="{{$data->gambarArtikel}}" data-lightbox="gambarArtikel" data-title="Deskripsi Gambar">
                                <img src="{{$data->gambarArtikel}}" height="50%" width="30%" srcset="" id="existingImage">
                            </a>
                        @else
                            <a href="{{asset('gambarArtikel/'.$data->gambarArtikel)}}" data-lightbox="gambarArtikel" data-title="Deskripsi Gambar">
                                <img src="{{asset('gambarArtikel/'.$data->gambarArtikel)}}" height="50%" width="30%" srcset="" id="existingImage">
                            </a>
                        @endif
                    @endif
