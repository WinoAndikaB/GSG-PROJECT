        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <a href="/formTambahTdanCSA" class="btn btn-primary">Tambah Syarat</a>
                              ...
                              <tr>
                                ...
                                <td class="align-middle text-center">
                                  <p class="text-xs font-weight-bold mb-0" style="white-space: normal; max-width: 1000px;">
                                    <?php
                                    $deskripsi = strip_tags($item['deskripsisyarat']);
                                ...
                                <td class="align-middle">
                                  <a href="/formEditTdanCSA/{{ $item->id }}" class="btn btn-warning btn btn-primary btn-round">
                                    <i class="fa fa-pencil"></i>
                                </a>
                                  <a href="#" class="btn btn-danger btn-icon btn-round" onclick="showConfirmationModal('{{ route('deleteTdanCSA', ['id' => $item['id']]) }}')">
