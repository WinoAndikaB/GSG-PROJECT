      ...
      <div class="container-fluid py-1 px-3">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          <div class="ms-md-auto pe-md-3 d-flex align-items-center">
            <form action="{{ route('videoSuperAdmin') }}" method="GET" class="d-flex">
                @csrf
                <div class="input-group">
                    <span class="input-group-text"><i class="fas fa-search" aria-hidden="true"></i></span>
                    <input type="text" name="search" class="form-control" placeholder="Cari Video..." value="{{ request('search') }}">
                </div>
        ...
        <div class="col-12">
          <div class="card mb-4">
            <div class="card-header pb-0">
              <a href="/formTambahVideoSA" class="btn btn-primary">Tambah Video</i></a>
              <a href="/komentarVideoSA" class="btn btn-success">Komentar Video + {{ $dataBaruKomentarVideo}}
              </i></a>
