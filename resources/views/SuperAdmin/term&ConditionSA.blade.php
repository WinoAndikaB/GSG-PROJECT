...
<head>
  ...
  <title>
    Syarat & Ketentutuan | GSG PROJECT
  </title>
  <!--     Fonts and icons     -->
    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder text-white mb-0">Terms & Condition</h6>
        </nav>
                          ...
                          <table class="table align-items-center mb-0">
                            <thead>
                              <tr>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Judul T&C</th>
                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Deskripsi T&C</th>
                              ...
                              <tr>
                                ...
                                <td style="text-align: justify;">
                                  <p class="align-middle text-center" style="white-space: normal; max-width: 1000px;">
                                    ...
                                    if (str_word_count($deskripsisyarat) > 100) {
                                      echo '...';
                                    }
                                    ?>
                                  </p>
                                ...
                                <td class="align-middle">
                                  <a href="/formEditTdanC/{{ $item->id}}" class="btn btn-warning btn btn-primary btn-round">
                                    <i class="fa fa-pencil"></i>
                                  </a>
                                  <a href="{{"deleteTdanC/".$item['id']}}" class="btn btn-danger btn btn-primary btn-round" onclick="return showConfirmation()">
