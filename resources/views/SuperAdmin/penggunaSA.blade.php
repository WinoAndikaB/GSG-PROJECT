                              ...
                              <td>
                                <div class="d-flex px-2 py-1">
                                  <div>
                                    ...
                                    @if($user->fotoProfil)
                                    @if(filter_var($user->fotoProfil, FILTER_VALIDATE_URL))
                                        <a href="{{$user->fotoProfil}}" data-lightbox="fotoProfil" data-title="Deskripsi Gambar">
                                            <img src="{{$user->fotoProfil}}" class="avatar avatar-sm me-3" alt="user1">
                                        </a>
                                    @else
                                        <a href="{{asset('fotoProfil/'.$user->fotoProfil)}}" data-lightbox="fotoProfil" data-title="Deskripsi Gambar">
